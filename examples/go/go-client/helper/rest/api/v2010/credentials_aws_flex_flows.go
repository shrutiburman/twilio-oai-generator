...
func (c *ApiService) CreateFlexFlow(params *CreateFlexFlowParams) (*TestResponseObject, error) {
	path := "/v1/Credentials/AWS/FlexFlows"
...
func (c *ApiService) ListFlexFlow(params *ListFlexFlowParams) ([]TestResponseObject, error) {
...
func (c *ApiService) StreamFlexFlow(params *ListFlexFlowParams) (chan TestResponseObject, chan error) {
	if params == nil {
...
func (c *ApiService) streamFlexFlow(response *ListFlexFlowResponse, params *ListFlexFlowParams, recordChannel chan TestResponseObject, errorChannel chan error) {
	curRecord := 1
